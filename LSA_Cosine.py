...
models_corpus = corpora.MmCorpus('SRSTopicModels/Corpora/alaska_srs_corpus')
models_dictionary = corpora.Dictionary.load('SRSTopicModels/Dictionaries/alaska_srs_dictionary')
csv_filename = "alaska_results.csv"
...
srs_lsa = gensim.models.LsiModel.load("SRSTopicModels/LSA TOPIC MODELS/alaska_lsa")
