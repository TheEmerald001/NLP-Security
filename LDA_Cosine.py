...
models_corpus = corpora.MmCorpus('SRSTopicModels/Corpora/srs_srs_corpus')
models_dictionary = corpora.Dictionary.load('SRSTopicModels/Dictionaries/srs_srs_dictionary')
csv_filename = "srs_results.csv"
...
capec_num = 1
srs_lda = gensim.models.LdaModel.load("SRSTopicModels/LDA TOPIC MODELS/srs_lda")
